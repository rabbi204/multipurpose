					...
					<div class="col-lg-4 col-md-5 col-12">
						...
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
							<form action="{{ route('login') }}" method="POST" autocomplete="off">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" id="email" name="email" autocomplete="off" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Enter your email">
                                        @error('email')
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" id="password" name="password" autocomplete="off" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password">
                                        @error('password')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
							...
							<div class="text-center">
								<p class="mt-15 mb-0 text-white">Don't have an account? <a href="{{ route('register') }}" class="text-warning text-bold ml-5">Sign Up</a></p>
							</div>
						</div>
					</div>
				</div>
